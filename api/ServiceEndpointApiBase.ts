...
export interface IServiceEndpointApiBase extends basem.ClientApiBase {
    ...
    acquireAccessToken(authenticationRequest: ServiceEndpointInterfaces.AadOauthTokenRequest): Promise<ServiceEndpointInterfaces.AadOauthTokenResult>;
...
export class ServiceEndpointApiBase extends basem.ClientApiBase implements IServiceEndpointApiBase {
    ...
    /**
     * @param {ServiceEndpointInterfaces.AadOauthTokenRequest} authenticationRequest
     */
    public async acquireAccessToken(
        authenticationRequest: ServiceEndpointInterfaces.AadOauthTokenRequest
        ): Promise<ServiceEndpointInterfaces.AadOauthTokenResult> {

        return new Promise<ServiceEndpointInterfaces.AadOauthTokenResult>(async (resolve, reject) => {
            let routeValues: any = {
            };
            ...
            try {
                ...
                let res: restm.IRestResponse<ServiceEndpointInterfaces.AadOauthTokenResult>;
                res = await this.rest.create<ServiceEndpointInterfaces.AadOauthTokenResult>(url, authenticationRequest, options);
