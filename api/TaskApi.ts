...
export interface ITaskApi extends basem.ClientApiBase {
    ...
    createIdToken(claims: { [key: string] : string; }, scopeIdentifier: string, hubName: string, planId: string, jobId: string, serviceConnectionName: string): Promise<string>;
    ...
    public async createIdToken(
        ...
        return new Promise<string>(async (resolve, reject) => {
            ...
            try {
                ...
                res = await this.rest.create<string>(url, claims, options);
