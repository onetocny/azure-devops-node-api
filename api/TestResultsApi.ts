...
export interface ITestResultsApi extends basem.ClientApiBase {
    ...
    getResultGroupsByBuild(project: string, buildId: number, publishContext: string, fields?: string[], continuationToken?: string): Promise<Contracts.FieldDetailsForTestResults[]>;
    getResultGroupsByRelease(project: string, releaseId: number, publishContext: string, releaseEnvId?: number, fields?: string[], continuationToken?: string): Promise<Contracts.FieldDetailsForTestResults[]>;
    ...
    getTestResultsByBuild(project: string, buildId: number, publishContext?: string, outcomes?: Contracts.TestOutcome[], top?: number, continuationToken?: string): Promise<Contracts.ShallowTestCaseResult[]>;
    getTestResultsByPipeline(customHeaders: any, project: string, pipelineId: number, stageName?: string, phaseName?: string, jobName?: string, outcomes?: Contracts.TestOutcome[], top?: number, continuationToken?: String): Promise<Contracts.ShallowTestCaseResult[]>;
    getTestResultsByRelease(project: string, releaseId: number, releaseEnvid?: number, publishContext?: string, outcomes?: Contracts.TestOutcome[], top?: number, continuationToken?: string): Promise<Contracts.ShallowTestCaseResult[]>;
    ...
    getTestLogsForBuild(customHeaders: any, project: string, buildId: number, type: Contracts.TestLogType, directoryPath?: string, fileNamePrefix?: string, fetchMetaData?: boolean, top?: number, continuationToken?: String): Promise<Contracts.TestLog[]>;
    getTestResultLogs(customHeaders: any, project: string, runId: number, resultId: number, type: Contracts.TestLogType, directoryPath?: string, fileNamePrefix?: string, fetchMetaData?: boolean, top?: number, continuationToken?: String): Promise<Contracts.TestLog[]>;
    getTestSubResultLogs(customHeaders: any, project: string, runId: number, resultId: number, subResultId: number, type: Contracts.TestLogType, directoryPath?: string, fileNamePrefix?: string, fetchMetaData?: boolean, top?: number, continuationToken?: String): Promise<Contracts.TestLog[]>;
    getTestRunLogs(customHeaders: any, project: string, runId: number, type: Contracts.TestLogType, directoryPath?: string, fileNamePrefix?: string, fetchMetaData?: boolean, top?: number, continuationToken?: String): Promise<Contracts.TestLog[]>;
...
export class TestResultsApi extends basem.ClientApiBase implements ITestResultsApi {
    ...
    public async getResultGroupsByBuild(
        ...
        ): Promise<Contracts.FieldDetailsForTestResults[]> {
        if (buildId == null) {
            throw new TypeError('buildId can not be null or undefined');
        }
        ...
        return new Promise<Contracts.FieldDetailsForTestResults[]>(async (resolve, reject) => {
            let routeValues: any = {
                project: project
            };
            ...
            try {
                ...
                let res: restm.IRestResponse<Contracts.FieldDetailsForTestResults[]>;
                res = await this.rest.get<Contracts.FieldDetailsForTestResults[]>(url, options);
    ...
    public async getTestResultsByBuild(
        ...
        top?: number,
        continuationToken?: string
        ): Promise<Contracts.ShallowTestCaseResult[]> {
        if (buildId == null) {
            throw new TypeError('buildId can not be null or undefined');
        }

        return new Promise<Contracts.ShallowTestCaseResult[]>(async (resolve, reject) => {
            let routeValues: any = {
                project: project
            };
            ...
            try {
                ...
                let res: restm.IRestResponse<Contracts.ShallowTestCaseResult[]>;
                res = await this.rest.get<Contracts.ShallowTestCaseResult[]>(url, options);
    ...
    public async getTestLogsForBuild(
        ...
        return new Promise<Contracts.TestLog[]>(async (resolve, reject) => {
            let routeValues: any = {
                project: project
            };
            ...
            try {
                ...
                let res: restm.IRestResponse<Contracts.TestLog[]>;
                res = await this.rest.get<Contracts.TestLog[]>(url, options);
